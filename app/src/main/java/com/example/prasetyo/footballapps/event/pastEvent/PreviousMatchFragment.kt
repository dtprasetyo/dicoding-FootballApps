package com.example.prasetyo.footballapps.event.pastEvent
...
import com.example.prasetyo.footballapps.event.EventPresenter
import com.example.prasetyo.footballapps.event.EventView
...
class PreviousMatchFragment : Fragment(), EventView {
    ...
    override fun showLeagueList(data: List<Leagues>) {
        ...
        spinAdapter = com.example.prasetyo.footballapps.event.SpinnerAdapter(ctx, android.R.layout.simple_spinner_dropdown_item, leagues)
